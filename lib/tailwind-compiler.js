...
class TailwindCompiler {
  ...
  generateMainCSS() {
    ...
    // Typography 颜色变量
    mainCSS += `  /* Typography 颜色系统 */\n`;
    mainCSS += `  --tw-prose-body: rgb(55 65 81);\n`;
    mainCSS += `  --tw-prose-headings: rgb(17 24 39);\n`;
    mainCSS += `  --tw-prose-lead: rgb(75 85 99);\n`;
    mainCSS += `  --tw-prose-links: rgb(79 70 229);\n`;
    mainCSS += `  --tw-prose-bold: rgb(17 24 39);\n`;
    mainCSS += `  --tw-prose-counters: rgb(107 114 128);\n`;
    mainCSS += `  --tw-prose-bullets: rgb(209 213 219);\n`;
    mainCSS += `  --tw-prose-hr: rgb(229 231 235);\n`;
    mainCSS += `  --tw-prose-quotes: rgb(17 24 39);\n`;
    mainCSS += `  --tw-prose-quote-borders: rgb(229 231 235);\n`;
    mainCSS += `  --tw-prose-captions: rgb(107 114 128);\n`;
    mainCSS += `  --tw-prose-code: rgb(17 24 39);\n`;
    mainCSS += `  --tw-prose-pre-code: rgb(229 231 235);\n`;
    mainCSS += `  --tw-prose-pre-bg: rgb(17 24 39);\n`;
    mainCSS += `  --tw-prose-th-borders: rgb(209 213 219);\n`;
    mainCSS += `  --tw-prose-td-borders: rgb(229 231 235);\n`;
    mainCSS += `}\n\n`;
    ...
    // 添加 prose 样式定义
    mainCSS += `/* Typography/Prose Styles */\n`;
    mainCSS += `.prose {\n`;
    mainCSS += `  color: var(--tw-prose-body);\n`;
    mainCSS += `  max-width: none;\n`;
    mainCSS += `  line-height: 1.75;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose h1 {\n`;
    mainCSS += `  color: var(--tw-prose-headings);\n`;
    mainCSS += `  font-weight: 800;\n`;
    mainCSS += `  font-size: 2.25em;\n`;
    mainCSS += `  margin-top: 0;\n`;
    mainCSS += `  margin-bottom: 0.8888889em;\n`;
    mainCSS += `  line-height: 1.1111111;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose h2 {\n`;
    mainCSS += `  color: var(--tw-prose-headings);\n`;
    mainCSS += `  font-weight: 700;\n`;
    mainCSS += `  font-size: 1.5em;\n`;
    mainCSS += `  margin-top: 2em;\n`;
    mainCSS += `  margin-bottom: 1em;\n`;
    mainCSS += `  line-height: 1.3333333;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose h3 {\n`;
    mainCSS += `  color: var(--tw-prose-headings);\n`;
    mainCSS += `  font-weight: 600;\n`;
    mainCSS += `  font-size: 1.25em;\n`;
    mainCSS += `  margin-top: 1.6em;\n`;
    mainCSS += `  margin-bottom: 0.6em;\n`;
    mainCSS += `  line-height: 1.6;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose h4 {\n`;
    mainCSS += `  color: var(--tw-prose-headings);\n`;
    mainCSS += `  font-weight: 600;\n`;
    mainCSS += `  margin-top: 1.5em;\n`;
    mainCSS += `  margin-bottom: 0.5em;\n`;
    mainCSS += `  line-height: 1.5;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose p {\n`;
    mainCSS += `  margin-top: 1.25em;\n`;
    mainCSS += `  margin-bottom: 1.25em;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose a {\n`;
    mainCSS += `  color: var(--tw-prose-links);\n`;
    mainCSS += `  text-decoration: underline;\n`;
    mainCSS += `  font-weight: 500;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose a:hover {\n`;
    mainCSS += `  color: rgb(67 56 202);\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose strong {\n`;
    mainCSS += `  color: var(--tw-prose-bold);\n`;
    mainCSS += `  font-weight: 600;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose code {\n`;
    mainCSS += `  color: var(--tw-prose-code);\n`;
    mainCSS += `  font-weight: 600;\n`;
    mainCSS += `  font-size: 0.875em;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose code::before {\n`;
    mainCSS += `  content: "\`";\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose code::after {\n`;
    mainCSS += `  content: "\`";\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose pre {\n`;
    mainCSS += `  color: var(--tw-prose-pre-code);\n`;
    mainCSS += `  background-color: var(--tw-prose-pre-bg);\n`;
    mainCSS += `  overflow-x: auto;\n`;
    mainCSS += `  font-weight: 400;\n`;
    mainCSS += `  font-size: 0.875em;\n`;
    mainCSS += `  line-height: 1.7142857;\n`;
    mainCSS += `  margin-top: 1.7142857em;\n`;
    mainCSS += `  margin-bottom: 1.7142857em;\n`;
    mainCSS += `  border-radius: 0.375rem;\n`;
    mainCSS += `  padding: 0.8571429em 1.1428571em;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose pre code {\n`;
    mainCSS += `  background-color: transparent;\n`;
    mainCSS += `  border-width: 0;\n`;
    mainCSS += `  border-radius: 0;\n`;
    mainCSS += `  padding: 0;\n`;
    mainCSS += `  font-weight: inherit;\n`;
    mainCSS += `  color: inherit;\n`;
    mainCSS += `  font-size: inherit;\n`;
    mainCSS += `  font-family: inherit;\n`;
    mainCSS += `  line-height: inherit;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose pre code::before,\n`;
    mainCSS += `.prose pre code::after {\n`;
    mainCSS += `  content: none;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose blockquote {\n`;
    mainCSS += `  font-weight: 500;\n`;
    mainCSS += `  font-style: italic;\n`;
    mainCSS += `  color: var(--tw-prose-quotes);\n`;
    mainCSS += `  border-left-width: 0.25rem;\n`;
    mainCSS += `  border-left-color: var(--tw-prose-quote-borders);\n`;
    mainCSS += `  quotes: "\\201C""\\201D""\\2018""\\2019";\n`;
    mainCSS += `  margin: 1.6em 0;\n`;
    mainCSS += `  padding-left: 1em;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose ul,\n`;
    mainCSS += `.prose ol {\n`;
    mainCSS += `  margin: 1.25em 0;\n`;
    mainCSS += `  padding-left: 1.625em;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose ul {\n`;
    mainCSS += `  list-style-type: disc;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose ol {\n`;
    mainCSS += `  list-style-type: decimal;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose ul > li,\n`;
    mainCSS += `.prose ol > li {\n`;
    mainCSS += `  position: relative;\n`;
    mainCSS += `  margin: 0.5em 0;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose hr {\n`;
    mainCSS += `  border-color: var(--tw-prose-hr);\n`;
    mainCSS += `  border-top-width: 1px;\n`;
    mainCSS += `  margin: 3em 0;\n`;
    mainCSS += `}\n\n`;
    
    // prose-sm 变体
    mainCSS += `.prose-sm {\n`;
    mainCSS += `  font-size: 0.875rem;\n`;
    mainCSS += `  line-height: 1.7142857;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose-sm h1 {\n`;
    mainCSS += `  font-size: 2.1428571em;\n`;
    mainCSS += `  margin-bottom: 0.8em;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose-sm h2 {\n`;
    mainCSS += `  font-size: 1.4285714em;\n`;
    mainCSS += `  margin-top: 1.6em;\n`;
    mainCSS += `  margin-bottom: 0.8em;\n`;
    mainCSS += `}\n\n`;
    
    mainCSS += `.prose-sm h3 {\n`;
    mainCSS += `  font-size: 1.2857143em;\n`;
    mainCSS += `  margin-top: 1.5555556em;\n`;
    mainCSS += `  margin-bottom: 0.4444444em;\n`;
    mainCSS += `}\n\n`;
